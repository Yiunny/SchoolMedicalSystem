...
import { Eye, EyeOff, Shield, Key, CheckCircle, Lock } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post("/auth/change-password", {
        oldPassword: "", // không cần vì là lần đầu
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 px-8 py-6 border-b border-gray-100">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-xl font-semibold text-gray-800">Đổi mật khẩu lần đầu</h2>
                </div>
                <p className="text-sm text-gray-600 mt-1">
                  Mật khẩu bạn đang dùng được cung cấp bởi trường học. Hãy thay đổi để đảm bảo an toàn tài khoản.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="p-8 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full border rounded-xl px-4 py-3 pr-12 focus:ring-2 focus:ring-blue-500/20 ${
                ...
                <div className="pt-6">
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white py-4 rounded-xl font-semibold hover:from-blue-600 hover:to-cyan-600 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>Sử dụng mật khẩu mạnh với ≥ 8 ký tự</li>
